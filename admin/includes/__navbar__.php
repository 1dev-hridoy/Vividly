...
@keyframes gradientText {
  0%    { color: #ff0000; }   /* Red */
  6.66% { color: #ff7f00; }   /* Orange */
  13.33%{ color: #ffff00; }   /* Yellow */
  20%   { color: #7fff00; }   /* Lime */
  26.66%{ color: #00ff00; }   /* Green */
  33.33%{ color: #00ff7f; }   /* Spring Green */
...
.color-cycle {
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="../../index3.html" class="brand-link">
      <img src="../assets/img/AdminLTELogo.png" alt="SiteLogo" class="brand-image img-circle elevation-3" style="opacity: .8">
      <span class="brand-text font-weight-light color-cycle">Admin</span>
